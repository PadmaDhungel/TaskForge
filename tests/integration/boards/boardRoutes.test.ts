// // tests/integration/boards/boardRoutes.test.ts
...
//         // Generate JWT
//         token = jwt.sign({ userId }, process.env.JWT_SECRET || "verysecret", {
//             expiresIn: "1h",
//         });
//     });
...
//             expect(res.body).toHaveProperty("board.id");
...
//                 data: { name: "Board Details", description: "Detail test" },
//             });
...
//             expect(res.statusCode).toBe(200);
//             expect(res.body.name).toBe("Board Details");
//         });
...
describe("Board Routes", () => {
    ...
    describe("POST /api/v1/boards", () => {
        it("should create a new board", async () => {
            ...
            expect(res.body.board.name).toBe("Test Board"); // ✅ Fixed
        });
